...
BEGIN
    ...
    ELSE
        ...
        END IF;
        IF (:NEW.HHOM_DATA_DATO <> :OLD.HHOM_DATA_DATO) THEN
            AUDITORIA.PROC_AUDITORIA(V_TABELA,V_ROWID,V_TP_OPERACAO,'HHOM_DATA_DATO',:OLD.HHOM_DATA_DATO,:NEW.HHOM_DATA_DATO,V_USU_BD,V_USU_SO,SYSDATE);
        END IF;
        IF (:NEW.HHOM_HORA_DATA_FATO <> :OLD.HHOM_HORA_DATA_FATO) THEN
            AUDITORIA.PROC_AUDITORIA(V_TABELA,V_ROWID,V_TP_OPERACAO,'HHOM_HORA_DATA_FATO',:OLD.HHOM_HORA_DATA_FATO,:NEW.HHOM_HORA_DATA_FATO,V_USU_BD,V_USU_SO,SYSDATE);
        END IF;
