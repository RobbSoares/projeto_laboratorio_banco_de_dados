...
--     unp_id INTEGER,
--     unp_numero_unidade VARCHAR2(26),
--     CONSTRAINT pk_unp PRIMARY KEY (unp_id),
--     CONSTRAINT ck_unp_numero_unidade CHECK (unp_numero_unidade is not null)
-- );

-- CREATE TABLE delegacias_policiais (
--     dpo_del_id INTEGER,
--     dpo_unp_id INTEGER,

--     CONSTRAINT pk_del_unp PRIMARY KEY (dpo_del_id, dpo_unp_id),
--     CONSTRAINT fk_dpo_del FOREIGN KEY (dpo_del_id) REFERENCES delegacias (del_id),
--     CONSTRAINT fk_dpo_unp FOREIGN KEY (dpo_unp_id) REFERENCES unidades_policiais (unp_id)
-- )
